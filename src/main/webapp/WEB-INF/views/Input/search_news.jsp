        ...
        <div class="input">
            <section class="content bgcolor-1">
                <span class="input input--haruki">
					<input class="input__field input__field--haruki" type="text" id="source"/>
					<label class="input__label input__label--haruki" for="source">
						<span class="input__label-content input__label-content--haruki">请输入检索内容 (不超过20个字)</span>
					</label>
				</span>
            </section>
        </div>
...
<script>
    function handle_submit() {
        if ($.trim($("#source").val()) != "") {
            ...
            $.post("Input/handle_search_news", {"keyword": $.trim($("#source").val())}, function (data) {
